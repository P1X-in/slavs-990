...
var battle_autoresolver = preload("res://scripts/services/battle_autoresolver.gd").new()
var battle_log = preload("res://scripts/services/battle_log.gd").new()
...
func _init(root_node):
    ...
    self.battle_autoresolver._init_bag(self)
